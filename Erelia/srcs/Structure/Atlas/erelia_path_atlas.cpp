...
const jgl::String Path_atlas::wrap_sub_path = "/wrap/";
const jgl::String Path_atlas::wrap_name_file = "wraps";
const jgl::String Path_atlas::wrap_save_extension = ".wrp";

const jgl::String Path_atlas::teleporter_sub_path = "/teleporter/";
const jgl::String Path_atlas::teleporter_name_file = "teleporters";
const jgl::String Path_atlas::teleporter_save_extension = ".tp";
...
const jgl::String Path_atlas::encounter_area_subpath = "/area/";
const jgl::String Path_atlas::encounter_area_name = "area";
const jgl::String Path_atlas::encounter_area_extension = ".area";
...
const jgl::String Path_atlas::monster_folder_path = "ressource/monster/";
const jgl::String Path_atlas::monster_file_extension = ".crea";
